...
public class CaregiverAssignmentSseService {
    ...
    private static final Logger logger = Logger.getLogger(CaregiverAssignmentSseService.class.getName());
    ...
    private void handleNotification(String json) {
        try {
            ...
            AssignmentChangeEvent event = new AssignmentChangeEvent().parseJson(jsonObject);
    ...
    private void broadcast(AssignmentChangeEvent event) {
