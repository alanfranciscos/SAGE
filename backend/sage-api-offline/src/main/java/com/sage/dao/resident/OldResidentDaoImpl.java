...
public class OldResidentDaoImpl implements ResidentDao {

    private static final Logger logger = Logger.getLogger(OldResidentDaoImpl.class.getName());

    private final Connection connection;

    public OldResidentDaoImpl(Connection connection) {
